...
execute if score @s DragonChargeTimer matches 15 at @s run function dragonai:tools/forcecharge
...
execute if score @s EnhancedAIPhase matches 0 if score @s DragonChargeTimer matches ..0 unless data entity @s {DragonPhase:9} run function dragonai:tools/gotorandom {xl:-70,xh:70,yl:85,yh:100,zl:-70,zh:70}
