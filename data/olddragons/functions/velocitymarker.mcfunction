...
execute at @s as @e[type=marker,limit=1,sort=nearest,tag=DragonChargeRotation,distance=..20] at @s facing entity @e[limit=1,tag=DragonVelocity,sort=nearest] feet run tp @s ^ ^ ^ ~180 ~
execute at @s store result score @s Rotation run data get entity @e[type=marker,limit=1,sort=nearest,tag=DragonChargeRotation] Rotation[0] 1000