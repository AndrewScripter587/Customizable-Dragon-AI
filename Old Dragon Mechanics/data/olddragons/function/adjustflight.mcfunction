...
execute if score YVel Temp > YVelUB Settings run scoreboard players operation YVel Temp = YVelUB Settings
execute if score YVel Temp < YVelLB Settings run scoreboard players operation YVel Temp = YVelLB Settings
